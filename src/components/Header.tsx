  ...
  return (
    <header className="no-print sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white px-4 shadow-sm sm:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {/* Plesk Windows / Node.js export quick button */}
        <button
          id="btn-header-plesk-download"
          type="button"
          onClick={onOpenPleskModal}
          className="flex items-center gap-1.5 rounded-lg border border-blue-200 bg-blue-50 px-2.5 py-1.5 text-xs font-semibold text-blue-800 hover:bg-blue-100 transition-colors shadow-xs"
          title="คู่มือ & แพ็กเกจติดตั้งบน Plesk Windows Server (Node.js)"
        >
          <Server className="h-4 w-4 text-blue-600" />
          <span className="hidden md:inline">ติดตั้ง Plesk / Windows</span>
        </button>
