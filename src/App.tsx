...
import { PleskWindowsModal } from './components/PleskWindowsModal';
...
export default function App() {
  ...
  const [isPleskModalOpen, setIsPleskModalOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-slate-100/70 flex flex-col font-sans text-slate-900">
      ...
      <Header
        ...
        onOpenPleskModal={() => setIsPleskModalOpen(true)}
      ...
      {/* Plesk Windows Server & Node.js Installation Modal */}
      <PleskWindowsModal
