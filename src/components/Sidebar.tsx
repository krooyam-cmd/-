      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4 space-y-1 text-sm custom-scrollbar">
          ...
          <div className="pt-3">
            ...
            <button
              id="sidebar-menu-plesk-pkg"
              type="button"
              onClick={() => {
                onOpenPleskModal();
                onClose();
              }}
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left text-xs font-semibold text-blue-300 bg-blue-900/40 hover:bg-blue-900/60 border border-blue-500/30 transition-colors shadow-xs"
            >
              <Server className="h-4 w-4 shrink-0 text-amber-300" />
              <span>คู่มือติดตั้ง Plesk (Windows Server)</span>
            </button>
          </div>
        </div>
